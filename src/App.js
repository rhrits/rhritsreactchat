...
firebase.initializeApp({
  apiKey: "AIzaSyDt0sVDKtmqvYu1ctOcVBw7Lo8hDxIBSnU",
  authDomain: "chatapp-a5f12.firebaseapp.com",
  projectId: "chatapp-a5f12",
  storageBucket: "chatapp-a5f12.appspot.com",
  messagingSenderId: "275899875602",
  appId: "1:275899875602:web:5cb2f9d48d5cca6dfc33cb",
  measurementId: "G-DZX9WTKV7R"
});
...
function App() {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-coolDark-500 dark:text-white transition-colors">
      ...
      >
        <a href="https://rhrits.me">
          <img src={brandLogo} alt="rhrits" width={150} />
        </a>
